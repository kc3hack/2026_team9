/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 1db01de48c5ec6823904f62ff3d9c4d1)
...
declare namespace Cloudflare {
	...
	interface DevelopEnv {
		...
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* kc3hack2026-9-front-develop */;
	}
	interface PrEnv {
		IMAGES: ImagesBinding;
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* kc3hack2026-9-front-pr */;
	}
	interface Env {
		NEXTJS_ENV: string;
		IMAGES: ImagesBinding;
		WORKER_SELF_REFERENCE: Fetcher /* kc3hack2026-9-front-develop */ | Fetcher /* kc3hack2026-9-front-pr */ | Service<typeof import("./.open-next/worker").default>;
		ASSETS?: Fetcher;
	}
}
