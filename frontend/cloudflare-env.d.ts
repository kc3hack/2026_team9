/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 7e99abfd740c2a033c9a3f3aa00c71b6)
...
declare namespace Cloudflare {
	...
	interface DevelopEnv {
		...
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* kc3hack2026-9-develop */;
	}
	interface PrEnv {
		IMAGES: ImagesBinding;
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* kc3hack2026-9-pr */;
	}
	interface Env {
		NEXTJS_ENV: string;
		IMAGES: ImagesBinding;
		WORKER_SELF_REFERENCE: Fetcher /* kc3hack2026-9-develop */ | Fetcher /* kc3hack2026-9-pr */ | Service<typeof import("./.open-next/worker").default>;
		ASSETS?: Fetcher;
	}
}
